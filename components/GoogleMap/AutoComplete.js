...
const AutoComplete = () => {
    ...
    const onChangeAddress = (autocomplete) => {
      ...
      const reverseGeocode = ({ latitude: longiTude, longitude: latiTude}) => {
        const url = `${geocodeJson}?key=${apiKey}&latlng=${longiTude},${latiTude}`;
    ...
    return (
        ...
        <div>
          <div className={styles.search}>
            ...
            <button onClick={findMyLocation}><i className="fas fa-crosshairs"></i></button>
          </div>
